...
export default function GeneratedStoryReaderPage() {
      ...
      <div className="flex justify-center items-center min-h-[60vh]">
        <div className="text-center">
          ...
          <button
            ...
            className="mt-4 px-4 py-2 text-sm font-medium bg-indigo-600 text-white rounded-lg hover:bg-indigo-700"
          >
            Back to Stories
          </button>
        </div>
    ...
    <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="flex-1 text-center">
          ...
          <div className="flex items-center justify-center gap-2 mt-0.5">
            <span className="text-xs text-gray-400 capitalize">
              {THEME_EMOJI[story.theme] || '\u2728'} {story.theme}
            </span>
            {story.coveragePct !== null && (
              ...
              >
                {Math.round(story.coveragePct * 100)}% word coverage
              </span>
            )}
          </div>
        </div>
      ...
      {activeWords.length > 0 && story && (
        <VocabularySpotlight
          ...
          storyText={story.pagesJson.map(p => p.text).join(' ')}
